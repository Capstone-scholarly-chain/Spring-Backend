...
//    COMMITTEE_REJECT_DEPOSIT(HttpStatus.INTERNAL_SERVER_ERROR, "COMMITTEE_005", "학생회 입금 거절 실패."),
    ...
    COUNT_TIMEOUT(HttpStatus.INTERNAL_SERVER_ERROR, "TIMEOUT_002", "학생/학생회 조직원 수 응답 타임아웃"),
    COUNT_NOT_AVAILABLE(HttpStatus.INTERNAL_SERVER_ERROR, "TIMEOUT_003", "학생/학생회 조직원 수 응답 후에도 값이 없음"),
