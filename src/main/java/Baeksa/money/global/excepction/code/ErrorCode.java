...
public enum ErrorCode implements BaseErrorCode {
    ...
    DATA_NOT_AVAILABLE(HttpStatus.INTERNAL_SERVER_ERROR, "TIMEOUT_003", "학생 조직원 수 응답 후에도 값이 없음"),
    GET_USER_STATUS_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "TIMEOUT_003", "학생 조직원 수 응답 후에도 값이 없음"),
    GET_PENDING_REQUESTS_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "TIMEOUT_003", "학생 조직원 수 응답 후에도 값이 없음"),
//    REQUEST_TIMEOUT(HttpStatus.INTERNAL_SERVER_ERROR, "TIMEOUT_003", "학생 조직원 수 응답 후에도 값이 없음"),
/// /집가서 에러 수ㅜ정하기
    ...
    STUDENT_COUNCIL_COUNT_REQUEST_FAILED(HttpStatus.BAD_REQUEST, "BLOCKCHAIN_007", "학생회 수 조회 실패"),
